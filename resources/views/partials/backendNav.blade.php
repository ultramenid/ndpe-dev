        ...
        <nav class="-mb-px flex space-x-6 text-sm leading-5 overflow-x-auto scrollbar-hide text-gray-500">
            ...
            <div @click="pages = ! pages" @click.away="pages=false" class=" cursor-pointer flex-col flex hover:bg-gray-200 dark:hover:bg-newgray-700 py-3  rounded @if($nav == 'pages' )border-b-2  dark:border-gray-300 border-newgray-900 @endif " x-data="{pages:false}">
                ...
                <div class=" flex flex-col space-y-3 sm:w-1/6 w-2/6  rounded sm:absolute relative sm:mt-10 mt-2 z-20 bg-gray-200 dark:bg-newgray-700  px-4 py-2" x-show="pages" x-cloak style="display: none !important">
                    <a  href="{{url('/cms/abouts')}}" class="hover:text-newgray-900 dark:hover:text-gray-300">About</a>
                    <a href="{{url('/cms/benchmarks')}}" class="hover:text-newgray-900 dark:hover:text-gray-300">Benchmark</a>
                    <a href="{{url('/cms/pagegroups')}}" class="hover:text-newgray-900 dark:hover:text-gray-300">Groups</a>
                </div>
            </div>
            ...
            <div class="hover:bg-gray-200 dark:hover:bg-newgray-700 py-3 px-2 rounded @if($nav == 'groups' )border-b-2  dark:border-gray-300 border-newgray-900 @endif ">
                <a href="{{url('/cms/listgroups')}}" class=" px-0.5  @if($nav == 'groups' )   text-newgray-900 dark:text-gray-300 @endif   hover:text-newgray-900 dark:hover:text-gray-300 cursor-pointer" >Groups</a>
            </div>
            <div class="hover:bg-gray-200 dark:hover:bg-newgray-700 py-3 px-2 rounded @if($nav == 'updates' )border-b-2  dark:border-gray-300 border-newgray-900 @endif ">
                <a href="{{url('/cms/eksternal')}}" class=" px-0.5  @if($nav == 'updates' )   text-newgray-900 dark:text-gray-300 @endif   hover:text-newgray-900 dark:hover:text-gray-300 cursor-pointer" >Updates</a>
            </div>
