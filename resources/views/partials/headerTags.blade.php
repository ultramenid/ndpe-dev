    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2 text-gray-300 text-sm">
                <a href="{{ route(Route::currentRouteName(), ['en', $tag]) }}"  class="cursor-pointer @if(App::getLocale() == 'en') text-white font-bold @endif">EN</a>
                <div class="border-l border-gray-300"></div>
                <a href="{{ route(Route::currentRouteName(), ['id', $tag]) }}"  class="cursor-pointer @if(App::getLocale() == 'id') text-white font-bold @endif ">ID</a>
                <div class="border-l border-gray-300"></div>
                <a href="{{ route(Route::currentRouteName(), ['jp', $tag]) }}"  class="cursor-pointer @if(App::getLocale() == 'jp') text-white font-bold @endif">JP</a>
            </div>
        </div>
