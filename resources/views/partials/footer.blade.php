<div class="bg-border-ndpe">
    <div class="max-w-6xl mx-auto relative px-6 py-8">
        ...
        <div class=" mb-5">
            ...
            <a href="#" class="font-bold text-brown-ndpe text-2xl">THE PLATFORM</a>
        ...
        <div class="flex sm:flex-row flex-col justify-between sm:space-x-10 space-x-0 space sm:space-y-0 space-y-6">
            ...
            <div class="sm:w-6/12 w-full">
                ...
                <p class="text-xss text-brown-ndpe mt-2 ">{{__('You still can unsubscribe after subcribing us.')}}</p>
            </div>
        </div>
...
<div class="bg-black flex justify-center">
    <a class="text-brown-ndpe py-1">All right reserved © 2021</a>
</div>
