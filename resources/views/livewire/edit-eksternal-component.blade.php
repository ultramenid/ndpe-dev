    ...
    <div class="grid grid-cols-12 gap-x-4" >
        ...
        <div class="sm:col-span-9 col-span-12 " >
            ...
            <div x-show="tabs==='english'" x-cloak style="display: none !important">
                <div class="w-full border border-gray-300 dark:border-opacity-20 rounded px-6 py-6 mb-6" x-data="{count:{{ strlen($titleEN)}} }">
            ...
            <div class="w-full border border-gray-300 dark:border-opacity-20 rounded px-6 py-6 mb-6">
                ...
                <div class="flex flex-col" x-data="{count: {{strlen($sourcename)}}}">
                ...
                <div class="flex flex-col mt-4" x-data="{count:{{strlen($sourceurl)}}}">
