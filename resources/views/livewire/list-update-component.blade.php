                ...
                <div class="flex justify-between w-full ">
                    <div class="text-brown-ndpe sm:w-8/12 w-full">
                        ...
                        <div class="flex mt-4 sm:flex-row flex-col sm:space-x-2 space-x-0 space-y-1 sm:space-y-0 sm:items-center">
                            ...
                            <div class="flex flex-wrap  sm:justify-between space-x-2  space-y-1 sm:space-y-0 text-sm">
                                @php
                    ...
                    <div class="sm:flex hidden w-4/12 justify-end">
                        <img class="h-44 w-72 object-cover" src="{{ asset('/storage/files/photos/thumbnail/'.$item->img) }}" alt="{{$item->title}}">
                    </div>
                </div>
