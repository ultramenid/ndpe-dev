        ...
        background-blend-mode:multiply;">
            ...
            <div class="max-w-6xl mx-auto  px-6 py-6">
                ...
                <p class="leading-relaxed text-gray-200 mt-6 sm:w-8/12 w-full   ">
                    {{__('NGOs supporting this website worked together to develop the following joint recommendations on deforestation risk commodities. The group has initially developed the following recommendations for deforestation risk commodities produced in Indonesia with the intention of applying and, as warranted, adapting them to other countries and regions producing deforestation commodities. The recommendations can be applied globally, but have been developed with strong emphasis on oil palm and pulp, paper, chips, timber and other forest products in moist tropical forest regions like Indonesia (as of 10 Nov 2020).')}}
                </p>
                <p class="leading-relaxed text-gray-200 mt-6 sm:w-8/12 w-full   ">
                    {{__('The three sets of recommendations are built around the following four terms which have minimum requirements drafted by the NGOs:')}}
                    <ul class="list-disc text-gray-200 px-8 sm:w-8/12 w-full    ">
                        <li class="leading-relaxed">{{__('Credible policy on no deforestation, no natural ecosystem or peat conversion/ degradation, no exploitation & environmentally and socially responsible supply chains and investments')}}</li>
                        <li class="leading-relaxed">
                            {{__('Transparent and collaborative monitoring systems.')}}
                        </li>
                        <li class="leading-relaxed">
                            {{__('Independent verification of the credible policy compliance and implementation progress.')}}
                        </li>
                        <li class="leading-relaxed">
                            {{__('Effective grievance mechanisms and conflict resolution procedures.')}}
                        </li>
                    </ul>
                </p>
                    ...
                    <div class="sm:w-7/12 w-full mt-10">
                        ...
                        <div x-show=" recs === 'brands' " x-cloak style="display: none !important" class="min-h-screen">
                            <ul class="list-decimal px-8 text-gray-200 space-y-2">
                                <li class="leading-relaxed">{{__('Adopt and publish a credible policy on no deforestation, no natural ecosystem or peat conversion/ degradation, no exploitation & environmentally and socially responsible supply chains and investments. It must apply across global corporate group operations of their suppliers or clients. They must commit to supporting proximate conservation and restoration of natural ecosystems, including financing, and remediation of their social and environmental harms.')}}
                                </li>
                                <li class="leading-relaxed">
                                    {{__('Implement the policy across all raw material source areas and landbanks under the influence of suppliers and clients in its global supply chains and investments at the corporate group level.')}}
                                </li>
                                <li class="leading-relaxed">
                                    {{__('Purchase products shown by independent verification to have no raw materials violating the policy and follow non-compliance protocols[6] to engage, retain, suspend or stop/avoid non-compliant suppliers. Stop or avoid sourcing from corporate groups producing/sourcing/processing commodities, who are violating the policy and/or those disassociated from credible certification systems[7] and have failed to implement corrective actions and remedy negative impacts.')}}
                                </li>
                                <li class="leading-relaxed">
                                    {{__('Preference doing business with or investment in companies and smallholder farmers producing / sourcing/ processing commodities in a manner shown by independent verification as compliant with the policy.')}}
                                </li>
                                <li class="leading-relaxed">
                                    {{__('Demonstrate policy compliance and implementation progress through transparent and collaborative monitoring systems, independent verification and annual reporting.')}}
                                </li>
                                <li class="leading-relaxed">
                                    {{__('Demonstrate conservation and restoration of natural ecosystems, including finance and support and rights based approaches.')}}
                                </li>
                                <li class="leading-relaxed">
                                    {{__('Support commodity production models that demonstrate alternatives to expansion of industrial plantations and advocate for legal recognition of land rights for forest peoples.')}}
                                </li>
                                <li class="leading-relaxed">
                        ...
                        <div x-show=" recs ==='individual'" x-cloak style="display: none !important" class="min-h-screen">
                            <ul class="list-decimal px-8 text-gray-200 space-y-2">
                                <li class="leading-relaxed">
                                    {{__('Purchase products shown by independent verification to have no raw materials violating the credible policy.')}}
                                </li>
                                <li class="leading-relaxed">
                                    {{__('Ask for information on the origins of products where unknown and demand your shops to sell products that are shown by independent verification to have no trace of raw materials violating the policy or, better yet, ask for recycled products.')}}
                                </li>
                                <li class="leading-relaxed">
                                    {{__('Take action today to influence the behaviours of corporate groups producing/sourcing/processing/trading or brands, end users and investors sourcing or investing in deforestation risk commodities.')}}
                                </li>
                            </ul>
                        </div>
                    </div>
