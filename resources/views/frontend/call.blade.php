...
@section('content')
    ...
    background-blend-mode:multiply;">
        ...
        <div class="max-w-6xl mx-auto relative px-6 py-6">
            ...
            <p class="leading-relaxed text-gray-200 mt-6 w-8/12">
            ...
            <p class="leading-relaxed text-gray-200 mt-6 w-8/12">
                ...
                <ul class="list-disc text-gray-200 px-8 w-8/12">
            ...
            <h1 class="font-notoserif text-5xl text-gray-200 mt-16">Recommendation</h1>
            <div class="flex justify-between" x-data="{ recs : 'corporate' }">
                <div class="w-5/12 flex flex-col space-y-4 text-gray-200 mt-12">
                    <div class="border-b border-white w-11/12">
                        <a :class="{ 'font-bold' : recs === 'corporate' }" @click=" recs = 'corporate' " class="text-2xl font-light cursor-pointer uppercase">CORPORATE</a>
                    </div>
                    <div class="border-b border-white w-11/12">
                        <a :class="{ 'font-bold' : recs === 'brands' }" @click=" recs = 'brands'"   class="text-2xl font-light cursor-pointer uppercase">Brands, End Users, Investors</a>
                    </div>
                    <div class="border-b border-white w-11/12">
                        <a :class="{ 'font-bold' : recs === 'individual' }" @click=" recs = 'individual' "  class="text-2xl font-light cursor-pointer uppercase">Individual Consumers</a>
                    </div>
                </div>
